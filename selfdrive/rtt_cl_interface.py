...
# TODO:  Write a log file every time a change is made to a parameter.
#   you can run  script  xx0000.log  before you run the command, it save it in openpilot/selfdrive, you can ssh in and download
#   oh, to end the script, ctrl+c ,  then type "exit"
